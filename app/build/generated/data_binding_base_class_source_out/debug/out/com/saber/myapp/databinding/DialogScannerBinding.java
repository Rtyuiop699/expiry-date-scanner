...
public final class DialogScannerBinding implements ViewBinding {
  ...
  private DialogScannerBinding(@NonNull FrameLayout rootView, @NonNull PreviewView viewFinder) {
  ...
  public static DialogScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogScannerBinding((FrameLayout) rootView, viewFinder);
    }
